...
public class SoapHelper {
    ...
    public Issue addIssue(Issue issue) throws MalformedURLException, ServiceException, RemoteException {
        ...
        IssueData createdIssueData = mc.mc_issue_get("administrator", "root", issuedId);
    ...
    public String getIssueStatus(int issue_id) throws MalformedURLException, ServiceException, RemoteException {
        MantisConnectPortType mc = getMantisConnect();
        IssueData issue = mc.mc_issue_get("administrator", "root",
                BigInteger.valueOf(issue_id));
